...
class OrderListScreenMobile extends ConsumerStatefulWidget {
  const OrderListScreenMobile({super.key});

  @override
  ConsumerState<OrderListScreenMobile> createState() => _OrderListScreenMobileState();
}

class _OrderListScreenMobileState extends ConsumerState<OrderListScreenMobile> {
              ...
              IconButton(
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    orderListNotifier.setFilter(startDate: startDate, endDate: endDate);
                  } else {
                    setState(() {
                      startDate = null;
                      endDate = null;
                    });
                    orderListNotifier.setFilter(startDate: fiscalYear?.$1, endDate: fiscalYear?.$2);
                  }
                },
            ...
            children: [
              ...
              Padding(
                ...
                child: AppTextForm<String>(
                  ...
                  onChanged: (value) {
                    orderListNotifier.setFilter(query: value);
                  },
              ...
              Expanded(
                child: RefreshIndicator(
                  onRefresh: () async {
                    orderListNotifier.setFilter();
                  },
                  child: PagedListView<int, SaleView>(
                    pagingController: orderListState.pagingController!,
                    builderDelegate: PagedChildBuilderDelegate<SaleView>(
                      ...
                      itemBuilder: (context, item, index) {
                        final items = orderListState.pagingController!.itemList;
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              item.createdAt.copyWith(isUtc: true).toLocal().toTime12WithDayFormat,
                                            ...
                                            Expanded(
                                              child: Text.rich(
                                                TextSpan(
                                                  children: [
                                                    TextSpan(
                                                      text: '${context.l10n.invoiceNo}: ',
                                                      style: AppText.mediumSB.copyWith(color: AppColors.black),
                                                    ),
                                                    TextSpan(
                                                      text: item.saleInvoice,
                                                      style: AppText.mediumSB.copyWith(color: AppColors.brandViolet),
                                                    ),
                                                  ],
                                                ),
                                              ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: AppText.smallSB.copyWith(color: AppColors.greyish),
                                        ),
                                      ),
                                    ],
                                  ),
