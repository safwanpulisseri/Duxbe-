...
class CustomerDetailsScreenMobile extends ConsumerStatefulWidget {
  const CustomerDetailsScreenMobile({super.key, this.customer});
  final Customer? customer;
  @override
  ConsumerState<CustomerDetailsScreenMobile> createState() => _CustomerDetailsScreenMobileState();
}

class _CustomerDetailsScreenMobileState extends ConsumerState<CustomerDetailsScreenMobile> {
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        AppPhoneNumberForm(
                          ...
                          initialValue: widget.customer?.phone == null ? ref.read(countryCodeProvider) : PhoneNumber.parse(widget.customer?.phone ?? ''),
