...
class OrderDetailsScreenMobile extends ConsumerStatefulWidget {
  const OrderDetailsScreenMobile({required this.sale, super.key});
  final SaleView sale;
  @override
  ConsumerState<OrderDetailsScreenMobile> createState() => _OrderDetailsScreenMobileState();
}

class _OrderDetailsScreenMobileState extends ConsumerState<OrderDetailsScreenMobile> {
  @override
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(context.l10n.status, style: AppText.mediumM.copyWith(color: AppColors.title)),
                      if (widget.sale.status!.name != 'Completed' && widget.sale.status!.name != 'Cancelled')
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (item.subServices.isNotEmpty)
                                Text(
                                  item.subServices.map((e) => e.name).join('\n'),
