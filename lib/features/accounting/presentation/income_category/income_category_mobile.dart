...
class IncomeCategoryScreenMobile extends ConsumerStatefulWidget {
  const IncomeCategoryScreenMobile({super.key});

  @override
  ConsumerState<IncomeCategoryScreenMobile> createState() => _IncomeCategoryScreenMobileState();
}

class _IncomeCategoryScreenMobileState extends ConsumerState<IncomeCategoryScreenMobile> {
                    ...
                    showDialog<void>(
                      ...
                      builder: (context) => Consumer(
                        builder: (context, ref, child) => ConfirmationDialog(
                          isLoading: ref.watch(incomeCategoryNotifierProvider).status == IncomeCategoryStatus.loading,
                          ...
                          onPositive: (ref) {
                            ref
                                ...
                                .deleteIncomeCategory(itemCategory)
                                .then(AppRouter.pop);
                          },
                        ),
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return switch (ref.watch(authNotifierProvider).status) {
      ...
      AuthStatus.success => Scaffold(
          appBar: CustomAppBar(
            title: Text(context.l10n.incomeCategory),
          ),
          ...
          body: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: AppTextForm<String>(
                  ...
                  onChanged: (value) {
                    _debouncer.run(
                      () {
                        incomeCategoryNotifier.setFilter(query: value);
                      },
                    );
                  },
              ...
              const SizedBox(height: 12),
              Expanded(
                child: PagedListView<int, TransactionCategory>(
                  pagingController: incomeCategoryState.pagingController!,
