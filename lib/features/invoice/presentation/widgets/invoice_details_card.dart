...
class InvoiceDetailsCard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InvoiceDetailsCard> createState() => _InvoiceDetailsCardState();
}

class _InvoiceDetailsCardState extends ConsumerState<InvoiceDetailsCard> {
  @override
        ...
        SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.status == InvoiceFormStatus.paid
                    ? '${widget.currencyCode} 0'
                    : '${widget.currencyCode} ${widget.balanceDue.toStringAsFixed(2)}',
