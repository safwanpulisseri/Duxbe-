...
class CreditNoteDetailsCard extends ConsumerStatefulWidget {
  const CreditNoteDetailsCard({
    ...
    required this.note,
    required this.creaditRemaining,
    ...
    this.businessPhone,
    this.businessEmail,
    this.status = CreditNoteFormStatus.open,
  });
  ...
  final CreditNoteFormStatus status;
  final double cgst;
  final double sgst;
  final double total;
  final double creaditRemaining;
  ...
  @override
  ConsumerState<CreditNoteDetailsCard> createState() => _CreditNoteDetailsCardState();
}

class _CreditNoteDetailsCardState extends ConsumerState<CreditNoteDetailsCard> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.type != InvoiceType.quote) ...[
                ...
                Text(
                  context.l10n.creditsRemaining,
                  style: AppText.smallM.copyWith(color: AppColors.stormyBlue),
                ),
                Text(
                  '${widget.currencyCode} ${widget.creaditRemaining.toStringAsFixed(2)}',
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  widget.type == InvoiceType.credit ? context.l10n.creditDate : context.l10n.quoteDate,
                  style: AppText.smallN.copyWith(color: AppColors.stormyBlue),
                ),
                const SizedBox(height: 4),
