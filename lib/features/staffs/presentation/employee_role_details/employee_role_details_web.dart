...
class EmployeeRoleDetailsScreenWeb extends ConsumerStatefulWidget {
  const EmployeeRoleDetailsScreenWeb({super.key, this.employeeRole});
  final StaffRole? employeeRole;
  @override
  ConsumerState<EmployeeRoleDetailsScreenWeb> createState() => _EmployeeRoleDetailsScreenWebState();
}

class _EmployeeRoleDetailsScreenWebState extends ConsumerState<EmployeeRoleDetailsScreenWeb> {
      ...
      child: FormBuilder(
        ...
        child: Column(
          ...
          children: [
            AppTextForm<String>(
              name: 'name',
              label: AppRouter.l10n.userRoleName,
