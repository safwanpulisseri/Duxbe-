...
class PurchaseSuccessScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final purchaseId = GoRouterState.of(context).pathParameters['id'];
    final currency = ref.watch(currencyProvider);
    return ref.watch(purchaseProvider(purchaseId)).when(data: (data) {
      return Scaffold(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppButton(
                            onPress: () {
                                context.goNamed(AppRouter.purchaseMore);
                            },
                          ...
                          AppButton(
                            ...
                            onPress: () async {
                              await PdfService.printPurchaseInvoice(data);
                            },
