part of 'purchase_payment_mobile.dart';

class PurchaseKeypadScreen extends ConsumerStatefulWidget {
  const PurchaseKeypadScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _PurchaseKeypadScreenState();
}

class _PurchaseKeypadScreenState extends ConsumerState<PurchaseKeypadScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final cartState = ref.watch(purchaseNotifierProvider);
    final cartNotifier = ref.read(purchaseNotifierProvider.notifier);
            ...
            children: [
                        ...
                        .map(
                          (e) => Expanded(
                            child: AppButton(
                              ...
                              onPress: () {
                                final paymentAmounts = formValue<Map<PaymentMode, String>>(
                                  'payment_details',
                                ).value!;
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '${context.l10n.supplierWallet} $currency ${cartState.supplier?.supplierBalance.toStringAsFixed(2) ?? ''}',
                    ...
                    Expanded(
                      child: AppToggleForm(
                        ...
                        onChanged: (val) {
                          cartNotifier.updateSupplierWallet(
                            useWallet: val ?? false,
                          );
                        },
                            ...
                            Expanded(
                              ...
                              child: AppButton(
                                ...
                                onPress: () {
                                  ...
                                  cartNotifier.createPurchaseTransaction().then(
                                    (value) {
                                      if (context.mounted) {
                                        context.pushNamed(
                                          AppRouter.purchaseSuccess,
                                          pathParameters: {
                                            'id': value.purchaseId,
                                          },
                                        );
