...
extension AppStylesX on AppStyles {
  static PlutoGridConfiguration get dataTableConfig => const PlutoGridConfiguration(
        ...
        style: PlutoGridStyleConfig(
          ...
          oddRowColor: AppColors.oddRowColor,
...
extension SpacingExtension on Flex {
  Flex withSpacing({
    ...
    final spacedChildren = children
        .expand(
          (widget) => [widget, seperator ?? SizedBox.square(dimension: spacing)],
        )
        .toList();
