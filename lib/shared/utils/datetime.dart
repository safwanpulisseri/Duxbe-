...
class DateTimeUtils {
  ...
  static final apiDateFormatWithoutTimeZone = DateFormat('yyyy-MM-dd HH:mm:ss.SSSSSS');
  // 2023-07-13T10:48:15
  static final apiDateFormatWithoutMilliSecond = DateFormat("yyyy-MM-dd'T'HH:mm:ss");
  ...
  // Monday, 04:00 PM
  static final timeFormat12WithDay = DateFormat('EEEE, hh:mm a');
  // 08:05 AM, 8th Aug 24
  static final timeFormat12WithDayWithMonth = DateFormat('hh:mm a, d MMM yyyy');
  // 12 October
  static final dateOnly = DateFormat('dd MMMM');
  // 12 October 2024
  static final dateOnlyWithYear = DateFormat('dd MMMM yyyy');
  // 2023 March 9th
...
extension DateExtension on String {
  ...
  DateTime get dateOnlyWithYear => DateTimeUtils.dateOnlyWithYear.parse(this);
  DateTime get time12WithDayToDate => DateTimeUtils.timeFormat12WithDay.parse(this);
  DateTime get time12WithDayWithMonthToDate => DateTimeUtils.timeFormat12WithDayWithMonth.parse(this);
  DateTime get apiToDateWithoutMilliSecond => DateTimeUtils.apiDateFormatWithoutMilliSecond.parse(this);
}
...
extension DateTimeExtension on DateTime {
  ...
  String get toApiDateFormatWithoutTimeZone => DateTimeUtils.apiDateFormatWithoutTimeZone.format(this);
  ...
  String get toDateOnly => DateTimeUtils.dateOnly.format(this);
  String get toDateOnlyWithYear => DateTimeUtils.dateOnlyWithYear.format(this);
  String get toInvoiceFormat => DateTimeUtils.invoiceFormat.format(this);
  String get dateWithoutTimeFormat => DateTimeUtils.dateWithoutTimeFormat.format(this);
  String get toTime12WithDayFormat => DateTimeUtils.timeFormat12WithDay.format(this);
  String get toTime12WithDayWithMonthFormat => DateTimeUtils.timeFormat12WithDayWithMonth.format(this);
...
List<String> getSortedTimeZones() {
  final timeZones = tz.timeZoneDatabase.locations.keys.toList()
    ..sort(
      (a, b) => tz.getLocation(a).currentTimeZone.offset - tz.getLocation(b).currentTimeZone.offset,
    );
